...
void RL0Scheduler::invokeScheduler(uint64_t tick) {
  const uint64_t currentTick = engine.getCurrentTick();
...
uint64_t RL0Scheduler::getNextDeadline() {
